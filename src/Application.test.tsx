...
describe("Application", () => {
  ...
  it("uses a bundler to bundle live components", async () => {
    ...
    jest.mock("./Style", () => ({ default: LiveComponent }));

    function UsesLiveComponent() {
      const LiveComponentX = useLiveComponent<typeof LiveComponent>("./Style");
    ...
    mockFileSystem.readFile.mockReturnValue(Buffer.from("x"));
